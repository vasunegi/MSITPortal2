...
public class HodDrawerActivity extends AppCompatActivity {

    // Navigation Drawer Titles and their corresponding Icons.
    String TITLES[] = {"Home", "My Deptt.", "Attendance Column", "Marksheet Area", "Reminders", "Make an announcement", "Notice Board", "Assignments", "Events"};
    ...
    public void setContentView(final int layoutResID) {
        DrawerLayout fullLayout = (DrawerLayout) getLayoutInflater()
                .inflate(R.layout.activity_hod_drawer, null);  // Inflating the drawer layout.
        ...
        final GestureDetector mGestureDetector = new GestureDetector(HodDrawerActivity.this, new GestureDetector.SimpleOnGestureListener() {
                ...
                if (child != null && mGestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    switch (recyclerView.getChildPosition(child)) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            Intent intent4 = new Intent(getApplicationContext(), MarksheetActivity.class);
