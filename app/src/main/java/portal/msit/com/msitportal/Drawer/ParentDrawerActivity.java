...
import portal.msit.com.msitportal.ParentDrawer.Parent_AttendanceActivity;
import portal.msit.com.msitportal.ParentDrawer.Parent_NoticeBoardActivity;
import portal.msit.com.msitportal.ParentDrawer.Parents_EventsActivity;
import portal.msit.com.msitportal.ParentDrawer.Parents_SyllabusActivity;
import portal.msit.com.msitportal.StudentDrawer.FavoriteActivity;
import portal.msit.com.msitportal.GuestDrawer.EventsActivity;
import portal.msit.com.msitportal.GuestDrawer.SyllabusActivity;
import portal.msit.com.msitportal.R;
import portal.msit.com.msitportal.StudentDrawer.AttendanceActivity;
import portal.msit.com.msitportal.StudentDrawer.MarksheetActivity;
import portal.msit.com.msitportal.StudentDrawer.ProfileActivity;
import portal.msit.com.msitportal.StudentDrawer.ReminderActivity;
import portal.msit.com.msitportal.Test2Activity;
import portal.msit.com.msitportal.TestActivity;


public class ParentDrawerActivity extends AppCompatActivity {

    // Navigation Drawer Titles and their corresponding Icons.
    String TITLES[] = {"Ward Attendance", "Syllabus", "Events", "Notice Board"};
    int ICONS[] = { R.drawable.ic_calendar, R.drawable.ic_message, R.drawable.ic_friends,  R.drawable.ic_calendar};

    // Header details - They can also be set programatically from within any activity that extends DrawerActivity.
    String NAME = "Father";
    String EMAIL = "father996@gmail.com";
    ...
    public void setContentView(final int layoutResID) {
        DrawerLayout fullLayout = (DrawerLayout) getLayoutInflater()
                .inflate(R.layout.activity_parent_drawer, null);  // Inflating the drawer layout.
        ...
        final GestureDetector mGestureDetector = new GestureDetector(ParentDrawerActivity.this, new GestureDetector.SimpleOnGestureListener() {
                ...
                if (child != null && mGestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    switch (recyclerView.getChildPosition(child)) {
                        case 0:
                            ...
                            Intent intent0 = new Intent(getApplicationContext(), Parent_AttendanceActivity.class);
                            startActivity(intent0);
                            finish();
                            break;
                        case 1:
                            // This will handle clicks on the Header of the Navigation Drawer.
                            Intent intent1 = new Intent(getApplicationContext(), Parent_AttendanceActivity.class);
                            startActivity(intent1);
                            finish();
                            break;
                        case 2:
                            // These cases will handle clicks on the Navigation Drawer.
                            Intent intent2 = new Intent(getApplicationContext(), Parents_SyllabusActivity.class);
                            startActivity(intent2);
                            finish();
                            break;
                        case 3:
                            Intent intent3 = new Intent(getApplicationContext(), Parents_EventsActivity.class);
                            startActivity(intent3);
                            finish();
                            break;
                        case 4:
                            Intent intent4 = new Intent(getApplicationContext(), Parent_NoticeBoardActivity.class);
                            startActivity(intent4);
                            finish();
                            break;
                      /*  case 5:
                            Intent intent5 = new Intent(getApplicationContext(), ReminderActivity.class);
                            startActivity(intent5);
                            finish();
                            break;
                        case 6:
                            Intent intent6 = new Intent(getApplicationContext(), SyllabusActivity.class);
                            startActivity(intent6);
                            finish();
                            break;
                        case 7:
                            Intent intent7 = new Intent(getApplicationContext(), TestActivity.class);
                            startActivity(intent7);
                            finish();
                            break;
                        case 8:
                            Intent intent8 = new Intent(getApplicationContext(), Test2Activity.class);
                            startActivity(intent8);
                            finish();
                            break;
                        case 9:
                            Intent intent9 = new Intent(getApplicationContext(), EventsActivity.class);
