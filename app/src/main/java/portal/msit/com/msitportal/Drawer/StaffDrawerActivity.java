...
import portal.msit.com.msitportal.StaffDrawer.MainActivity;
import portal.msit.com.msitportal.StaffDrawer.Staff_AttendanceActivity;
...
public class StaffDrawerActivity extends AppCompatActivity {
    ...
    String TITLES[] = {"Home", "Attendance Column"};
    ...
    String NAME = "Mr. Faculty";
    String EMAIL = "faculty996@gmail.com";
    ...
    public void setContentView(final int layoutResID) {
        DrawerLayout fullLayout = (DrawerLayout) getLayoutInflater()
                .inflate(R.layout.activity_staff_drawer, null);  // Inflating the drawer layout.
        ...
        final GestureDetector mGestureDetector = new GestureDetector(StaffDrawerActivity.this, new GestureDetector.SimpleOnGestureListener() {
